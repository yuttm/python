...
def mouse_update(win):
    ...
    #pygame.draw.circle(win, BLUE, mpos, 10)
...
def times_update(win):
    ...
    win.blit(end_sur, (bg_x - end_sur.get_width() - 10, 10))
...
def game_over(win):
    ...
    end_sur = score_font.render("score{}/{}".format(score, times_max), False,
                                RED)
    win.blit(end_sur, (200, 300))
